...
func NodeInfoMarshalJSON(version string, software shared.Software, protocols shared.Protocols, services shared.Services, openRegistrations bool, usage shared.Usage, metadata map[string]any) ([]byte, error) {
	var buffer [256]byte
