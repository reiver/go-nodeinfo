...
func NodeInfo2Dot2MarshalJSON(version string, instance shared.Instance, software shared.Software2Dot1, protocols []string, services shared.Services, openRegistrations bool, usage shared.Usage2Dot2, metadata map[string]any) ([]byte, error) {
	var buffer [256]byte
