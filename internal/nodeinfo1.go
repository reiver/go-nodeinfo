...
func NodeInfo1MarshalJSON(version string, software shared.Software1, protocols shared.Protocols1, services shared.Services1, openRegistrations bool, usage shared.Usage1, metadata map[string]any) ([]byte, error) {
	var buffer [256]byte
