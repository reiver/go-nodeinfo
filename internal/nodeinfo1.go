...
func NodeInfo1MarshalJSON(version string, software shared.Software1, protocols shared.Protocols1, services shared.Services, openRegistrations bool, usage shared.Usage, metadata map[string]any) ([]byte, error) {
	var buffer [256]byte
