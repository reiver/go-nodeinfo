...
func NodeInfo2Dot1MarshalJSON(version string, software shared.Software2Dot1, protocols []string, services shared.Services1, openRegistrations bool, usage shared.Usage1, metadata map[string]any) ([]byte, error) {
	var buffer [256]byte
