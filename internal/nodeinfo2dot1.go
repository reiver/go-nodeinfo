...
func NodeInfo2Dot1MarshalJSON(version string, software shared.Software2Dot1, protocols []string, services shared.Services, openRegistrations bool, usage shared.Usage, metadata map[string]any) ([]byte, error) {
	var buffer [256]byte
