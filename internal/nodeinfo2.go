...
func NodeInfo2MarshalJSON(version string, software shared.Software, protocols []string, services shared.Services, openRegistrations bool, usage shared.Usage, metadata map[string]any) ([]byte, error) {
	var buffer [256]byte
